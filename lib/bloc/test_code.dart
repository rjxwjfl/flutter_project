...
import 'database_bloc/model/project/project_set_model.dart';
import 'database_bloc/model/user/user_dtl_model.dart';

class TestCode{
  String baseUrl = "http://10.0.2.2:8080";

  Future<ProjectSetModel> getProject(int id) async{
    ...
    if (response.statusCode == 200){
      ...
      ProjectSetModel model = ProjectSetModel.fromMap(projectMap);
      return model;
    } else {
